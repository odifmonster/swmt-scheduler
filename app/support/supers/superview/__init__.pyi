...
def setter_like[U, **P, T](func: Callable[Concatenate[U, P], T]) -> Callable[Concatenate[U, P], T]:
    """
    A decorator for indicating a function is "setter-like". If a View
    object tries to call a setter-like method, it will raise a RuntimeError.
    """
    ...

class SuperView[T]:
    """
    A super class for creating types that can "view" information about other
    objects. "Viewed" attributes are live and read-only.
    """
