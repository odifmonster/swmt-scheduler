...
class Grouped(Generic[_T, _U], Viewable[GroupedView[_T, _U]], SuperImmut):
    ...
    @property
    def n_items(self) -> int:
        """The total ("flat") number of items in this Grouped object."""
        ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int:
    ...
    def __getitem__(self, key: _U | tuple) -> GroupedView[_T] | DataView[_T]:
        """
        Returns a view of the retrieved group or data with the provided attribute properties.
        The key's elements must be in order of the properties passed to the initializer. Passing
        an empty tuple is equivalent to calling Grouped.view().
        """
        ...
    def make_atom(self, data: Data[_T], *args: Unpack[tuple[str, ...]]) -> _Atom[_T]:
        """
