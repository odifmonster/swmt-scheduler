...
class Data(Generic[_T], HasID[_T], Viewable[DataView[_T]], SuperImmut):
    ...
    def __init_subclass__(cls, attrs: ArgTup = tuple(), priv_attrs: ArgTup = tuple(),
                          frozen: ArgTup = tuple()) -> None:
        """
        Create a new Data type. If no additional attributes are defined in 'frozen',
    ...
    def add_to_group(self) -> None:
        """Call when this object is added to a group."""
        ...
    def remove_from_group(self) -> None:
        """Call when this object is removed from a group."""
        ...
